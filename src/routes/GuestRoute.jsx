  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: "services", element: <Guest.ServicesPage /> },
        { path: "services/:serviceSlug", element: <Guest.ServiceDetailPage /> },
        { path: "news", element: <Guest.NewsPage /> },
        { path: "news/:newsSlug", element: <Guest.NewsDetailPage /> },
